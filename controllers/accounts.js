...
// Create Tiers Account
exports.createAccount = async (req, res) => {
    // Empty Inputs
    if (req.body.login === "" || req.body.password === "" || req.body.password2 === "" || req.body.role === "" ||
        req.body.login === undefined || req.body.password === undefined || req.body.password2 === undefined || req.body.role === undefined) {
    ...
    // Customer empty inputs
    if (req.body.role === 'customer') {
        if (req.body.firstName === "" || req.body.phone === "" || req.body.mail === "" || req.body.firstName === undefined || req.body.phone === undefined || req.body.mail === undefined) {
            return res.status(400).json({ message: "Merci de renseigner tous les Champs Obligatoires" });
        }
